namespace Game.Maps
{
	...
	public interface ICells<T> : IEnumerable<Vector2Int>
	{
		RectInt		Rect		{get;}
		Vector2Int	Size		{get;}
		Vector2Int	Min			{get;}
		...
		void Set( ICells<T> other, Vector2Int dstMin );
		void Set( ICells<T> other, RectInt srcRect, Vector2Int dstMin = default );
